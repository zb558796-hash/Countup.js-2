# Countup.js-2
CountUp.js-2 is a dependency-free, lightweight Javascript class that can be used to quickly create animations that display numerical data in a more interesting way.

Despite its name, CountUp can count in either direction, depending on the start and end values that you pass.

CountUp.js-2 supports all browsers. MIT license.

## [Try the demo](https://inorganik.github.io/countUp.js-2)
Or Check the og(https://inorganik.github.io/countup.js)
...
- [zb558796-hash 2+](https://github.com/inorganik/ngx-countUp-2)
- [zb558796 1.x](https://github.com/inorganik/countUp.js-2-zb558796-hash)
